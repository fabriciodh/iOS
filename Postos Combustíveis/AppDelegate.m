...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            //_persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Postos_Combusti_veis"];
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Postos_Combustíveis"];
